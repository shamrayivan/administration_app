...
@RoutePage()
class EfficiencyTransportFilterScreen extends CoreMwwmWidget {
  EfficiencyTransportFilterScreen()
      : super(
    widgetModelBuilder: (_) => EfficiencyTransportFilterScreenWM(),
  );

  @override
  State<StatefulWidget> createState() => _EfficiencyTransportFilterScreenState();
}

class _EfficiencyTransportFilterScreenState extends WidgetState<EfficiencyTransportFilterScreenWM> {
  @override
