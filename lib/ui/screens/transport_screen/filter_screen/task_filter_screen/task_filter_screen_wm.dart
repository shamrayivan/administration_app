...
class TaskFilterScreenWM extends WidgetModelStandard {
  final vehiclesStreamedState = getIt<TransportManager>().vehiclesTasksStreamedState;
  ...
  void onBind() {
    ...
    subscribe(onSave.stream, (value) {
      ...
      logger(data.length);
      doFutureHandleError(analysisLogisticManager.getAnalysisLogistic(modeID: 3, data: data),
          onValue: (_) {
            _appRouter.pop();
